...
import { CheckCircle, Trophy, Calendar, ChevronLeft, ChevronRight } from "lucide-react"
...
export function PickedUpList({ participants, className = "", onClear }: PickedUpListProps) {
